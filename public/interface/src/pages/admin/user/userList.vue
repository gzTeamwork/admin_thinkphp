<template>
  <mu-container>
    <h2>用户列表</h2>
    <mu-data-table fit selectable select-all :selects.sync="selects" checkbox :loading="loading" :columns="columns" :sort.sync="sort" @sort-change="handleSortChange" :data="userList.slice(0, 6)" :no-data-text="'暂无数据'">
      <template slot-scope="scope">
        ...
        <td class="is-center">
          ...
          <mu-icon color="red300" v-else value="highlight_off"></mu-icon>
        </td>
        <td class="is-right">
